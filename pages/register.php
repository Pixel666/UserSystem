...
<html lang="en">
  <head>
    ...
    <title>UserSystem Register</title>
...
.form-signin input[type="password"] {
  ...
  <body>
    ...
    <div class="container">
      ...
      <h1>Sign Up.</h1>
        <input name="register_username" type="text" class="form-control" placeholder="Username" autofocus>
        ...
        <a class="btn btn-lg btn-primary btn-block" href="index.php?page=login">Back to Login</a>
      </form>
